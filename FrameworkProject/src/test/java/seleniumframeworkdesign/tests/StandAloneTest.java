...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userPassword")).sendKeys("Allah786!");
		driver.findElement(By.id("login")).click();
		WebDriverWait wait = new WebDriverWait(driver,30);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(@class,'container')]")));
		List<WebElement> products = driver.findElements(By.xpath("//div[contains(@class,'container')]"));
